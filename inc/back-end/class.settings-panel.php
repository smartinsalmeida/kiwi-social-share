...
class Kiwi_Settings_Page extends Kiwi_Plugin_Utilities
{
    ...
    public function settings_fields()
    {
        ...
        $settings['left-side'] = array(
            ...
            'kiwi-sortable-field' => array(
                'type' => 'sortable-toggle',
                'id' => 'kiwi-sortable-field',
                'title' => '',
                'order' => array(
                    'kiwi_enable_reddit',
                    'kiwi_enable_linkedin',
                    'kiwi_enable_pinterest',
                    'kiwi_enable_twitter',
                    'kiwi_enable_facebook',
                    'kiwi_enable_email',
                    'kiwi_enable_google_plus'
                ),
                'options' => array(
        ...
        $settings['right-side'] = array(
            ...
            'kiwi-display-sizes-heading' => array(
            ...
            'kiwi-display-sizes' => array(
                'title' => '',
                'type' => 'radio',
                'id' => 'kiwi-display-sizes',
                'std' => 'large-size',
                'options' => array(
                    'small-size' => __('Small size', 'kiwi-social-share'),
                    'medium-size' => __('Medium size', 'kiwi-social-share'),
                    'large-size' => __('Large size', 'kiwi-social-share')
                ),
            ),
        );
