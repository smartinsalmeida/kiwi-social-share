...
class Kiwi_Render_Share_Bar extends Kiwi_Plugin_Utilities {
    ...
    public function display_bar( $content ) {
        ...
        if( is_singular() ) {
            ...
            $kiwi_display_fb = parent::get_option_value('kiwi_enable_facebook');
            $kiwi_display_twitter = parent::get_option_value('kiwi_enable_twitter');
            $kiwi_display_google_plus = parent::get_option_value('kiwi_enable_google_plus');
            $kiwi_display_linkedin = parent::get_option_value('kiwi_enable_linkedin');
            $kiwi_display_pinterest = parent::get_option_value('kiwi_enable_pinterest');
            $kiwi_display_reddit = parent::get_option_value('kiwi_enable_reddit');
            $kiwi_display_mail = parent::get_option_value('kiwi_enable_email');
            ...
            if( ($kiwi_display_on_posts == 1 && is_single() ) || ( $kiwi_display_on_pages == 1 && is_page() ) ) {
                ...
                $output .= '<ul class="kiwi-share-bar-wrapper ' . esc_attr( $kiwi_skin ) . '">';
    ...
    /**
     * Add og: meta tags to the header
     */
